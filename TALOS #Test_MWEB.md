...
## Test installazione su linux POP_OS 20.10 - (Debian based)

**Questa è un TEST / Tutorial per l'installazione di JENKINS in un Cluster K8S - TALOS**

### Pre-requisiti da installare :
...
**Premesso che i repo di docker siano installati. In caso contrario seguire i punti in : 
...
Creazione del file yalm per la creazione del conteiner docker di jenkins
...
![Schermata_del_2020-11-13_12-21-34](https://i.imgur.com/2UU61E6.png)
...
![Schermata_del_2020-11-13_12-35-30](https://i.imgur.com/D6Z5xpL.png)
