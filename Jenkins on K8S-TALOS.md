...
1. **Installation of Docker (v. 19.02 o sup.)** 
2. I**nstallation of Kubectl (v. GitVersion:"v1.19.3")**
3. I**nstallation e configuration of TALOS OS  (talosclt ver. 0.70 beta)**
4. **Creation a managemnet of K8S Cluster**
5. **Jenkins installation on cluster k8s**
6. **Deploy of JENKINS Conteiner**
7. **Distribution of Jenkins service**
8. **Clean UP and Conclusion** 

### 1. Docker installation :

Provided that docker repos are installed, Otherwise follow the points in  the link : 
...
N.B : If error appear, follow the link :[https://github.com/talos-systems/talos/release https://github.com/talos-systems/talos/releases](https://github.com/talos-systems/talos/releases)
and insert the right version **(amd64)** : https://github.com/talos-systems/talos/releases/download/v0.7.0-beta.1/talosctl-linux-amd64
...
❯ talosctl config nodes 10.5.0.2 **(<--------- VERY IMPORTANT!!!)**
...
### **Now, by your browser, you can access to Jenkins web interface**  : **http://10.5.0.2:30000**


![](Jenkins%20on%20K8S-TALOS/Schermata_del_2020-11-13_12-21-34.png)
...
![](Jenkins%20on%20K8S-TALOS/Schermata_del_2020-11-13_12-35-30.png)
